...
```typescript
import { getMarketGlobalState } from '@alphaarcade/alpha-sdk';
...
```typescript
import { getEscrowGlobalState } from '@alphaarcade/alpha-sdk';
import algosdk from 'algosdk';
...
```typescript
import { checkAssetOptIn } from '@alphaarcade/alpha-sdk';
import algosdk from 'algosdk';
...
```typescript
import { checkAssetOptIn, getMarketGlobalState } from '@alphaarcade/alpha-sdk';
import algosdk from 'algosdk';
